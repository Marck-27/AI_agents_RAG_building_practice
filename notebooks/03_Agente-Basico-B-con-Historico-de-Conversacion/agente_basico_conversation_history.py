...
TBL_NAME = "tbl_chat_history_text"  # Nombre de la tabla para almacenar el historial del chat
...
Responde siempre en español."""),
    MessagesPlaceholder(variable_name="history"),  # Aquí se inyecta el historial de la conversación
    ("human", "{input}")
])
...
def crear_tabla_historial(table_name: str = TBL_NAME):
...
def get_session_history(session_id: str) -> PostgresChatMessageHistory:
    ...
    return PostgresChatMessageHistory(
        ...
        sync_connection=sync_connection # conexión sincronizada a la base de datos
    )
